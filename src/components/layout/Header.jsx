                    ...
                    {user ? (
                        <div className="action-item" style={{ cursor: 'pointer' }} onClick={() => {
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', lineHeight: '1' }}>
                                ...
                                <span style={{ fontSize: '0.7rem', color: '#F48646' }}>Salir</span>
                            </div>
                        </div>
                    ) : (
